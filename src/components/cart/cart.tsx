                ...
                return (
                  ...
                  <Row className="item-cart justify-content-start">
                    ...
                    <Col md="5" className="item-info-container-cart">
                      ...
                      <Row className="col-item-cart"> <h5 className="item-price-cart">${price*amount}</h5></Row>
                    </Col>
        ...
        <Row id="products-info-cart" className="justify-content-center">
          ...
          <Row id="column-names-cart">
            ...
            <Row className="buy-info-cart"> 
              ...
              <Col className="result-buy-info-cart"><p>${subtotal}</p> </Col> 
            </Row>
            <Row className="buy-info-cart"> 
              <Col className="title-buy-info-cart"><p>Descuento</p></Col>
              <Col className="result-buy-info-cart"> <p>${discount}</p> </Col>
            </Row>
            <Row className="buy-info-cart"> 
            ...
            <Row className="buy-info-cart">
              ...
              <Col className="result-buy-info-cart"> <p>${total}</p> </Col>
            </Row>
          </Row>
        </Row>
